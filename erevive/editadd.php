...
<body style="background: #ccd8ea;">
    ...
    <div style="background: #ccd8ea;padding: 9px;">
        ...
        <form action="add.inc.php" enctype="multipart/form-data" method="POST">
            <table class="table table-striped table-bordered table-dark">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-center" colspan="7"><input type="submit" name="submit" value="Submit" class="btn btn-primary"></td>
                    </tr>
                </tbody>
            </table></form>
        </div>
